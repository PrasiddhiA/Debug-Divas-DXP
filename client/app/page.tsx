              ...
              {[
                {
                  ...
                  quote:
                    "EmpowerHub helped me launch my online store in just a few days. The AI content generator saved me hours of work!",
                },
                {
                  name: "Maria Rodriguez",
                  business: "Wellness Coach",
                  quote:
                    "As someone with no technical background, I was amazed at how easy it was to build my coaching website with EmpowerHub.",
                },
                {
                  name: "Jennifer Lee",
                  business: "Artisan Bakery",
                  quote:
                    "The e-commerce features have been a game-changer for my bakery. My sales have increased by 40% since joining EmpowerHub.",
                },
              ].map((testimonial, i) => (
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Join thousands of women entrepreneurs who are building their online presence with EmpowerHub.
                </p>
              </div>
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                <Link href="/signup">
      ...
      <footer className="w-full border-t py-6 md:py-0">
        <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
          <p className="text-center text-sm leading-loose text-muted-foreground md:text-left">
            © 2023 EmpowerHub. All rights reserved.
          </p>
          <div className="flex items-center gap-4">
